...
int main(int argc, char **argv)
{
    ...
    printf("\n[R998b] Disassemble 0x00257d30 (called 3x from within 0x0026fc18,\n"
           "return value gates further struct writes per Round 995):\n");
    dump_range(ee, 0x00257d20u, 0x00257de0u);
    printf("\n[R998b] Disassemble 0x00270c28 (called once, result stored to\n"
           "MEM[0x0040DB54] per Round 995's 0x0026fda0-0x0026fda4):\n");
    dump_range(ee, 0x00270c28u, 0x00270ca0u);
    return 0;
}
