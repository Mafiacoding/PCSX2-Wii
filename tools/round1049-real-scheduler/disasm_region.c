...
static const char *reg_name(uint32_t r){static const char*n[32]={"zero","at","v0","v1","a0","a1","a2","a3","t0","t1","t2","t3","t4","t5","t6","t7","s0","s1","s2","s3","s4","s5","s6","s7","t8","t9","k0","k1","gp","sp","fp","ra"};return n[r&0x1F];}
static const char *special_mn(uint32_t f){switch(f){
 case 0x00:return "sll";case 0x02:return "srl";case 0x03:return "sra";case 0x04:return "sllv";case 0x06:return "srlv";case 0x07:return "srav";
 case 0x08:return "jr";case 0x09:return "jalr";case 0x0A:return "movz";case 0x0B:return "movn";case 0x0C:return "syscall";case 0x0D:return "break";
 case 0x0F:return "sync";case 0x10:return "mfhi";case 0x11:return "mthi";case 0x12:return "mflo";case 0x13:return "mtlo";
 case 0x18:return "mult";case 0x19:return "multu";case 0x1A:return "div";case 0x1B:return "divu";
 case 0x20:return "add";case 0x21:return "addu";case 0x22:return "sub";case 0x23:return "subu";case 0x24:return "and";case 0x25:return "or";
 case 0x26:return "xor";case 0x27:return "nor";case 0x2A:return "slt";case 0x2B:return "sltu";default:return NULL;}}
static const char *regimm_mn(uint32_t rt){switch(rt){case 0:return "bltz";case 1:return "bgez";case 0x10:return "bltzal";case 0x11:return "bgezal";default:return NULL;}}
static void disasm_one(uint32_t w,uint32_t addr,char*out,size_t outsz){
 uint32_t op=w>>26,rs=(w>>21)&0x1F,rt=(w>>16)&0x1F,rd=(w>>11)&0x1F,sh=(w>>6)&0x1F,funct=w&0x3F;
 int16_t imm=(int16_t)(w&0xFFFF); uint32_t uimm=w&0xFFFF; uint32_t jt=(addr&0xF0000000u)|((w&0x03FFFFFFu)<<2);
 if(w==0){snprintf(out,outsz,"nop");return;}
 if(op==0x00){const char*mn=special_mn(funct); if(!mn){snprintf(out,outsz,".word 0x%08x",w);return;}
   ...
   snprintf(out,outsz,"%-7s $%s, $%s, $%s",mn,reg_name(rd),reg_name(rs),reg_name(rt)); return;}
 if(op==0x01){const char*mn=regimm_mn(rt); snprintf(out,outsz,"%-7s $%s, 0x%08x",mn?mn:"regimm?",reg_name(rs),addr+4+((int32_t)imm<<2)); return;}
 switch(op){
...
static uint32_t iop_ram_word(iop_state_t *iop, uint32_t addr){addr&=0x1FFFFF;if(addr+4>iop->ram_size)return 0xFFFFFFFF;
...
int main(int argc,char**argv){
 ...
 uint32_t start = strtoul(argv[3],NULL,16), end = strtoul(argv[4],NULL,16);
 for (uint32_t a=start;a<=end;a+=4){
   uint32_t w=iop_ram_word(iop,a); char line[192]; disasm_one(w,a,line,sizeof(line));
   printf("0x%08X: %08X  %s\n",a,w,line);
 }
 return 0;
}
