...
int main(int argc, char **argv)
{
    ...
    printf("\n[R996] Disassemble the two registered callback pointers found in Round 995's\n"
           "trace (buffer[0] entry at 0x0040DB80: +0=0x0026FEA8, +8=0x0026FEB8) - these look\n"
           "like real handler/callback functions associated with our struct:\n");
    printf("\n--- callback A: 0x0026FEA0-0x0026FF20 ---\n");
    dump_range(ee, 0x0026fea0u, 0x0026ff20u);
    return 0;
}
