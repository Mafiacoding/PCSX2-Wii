...
int main(int argc, char **argv)
{
    ...
    printf("\n[R995] Full disassembly of registration function 0x0026fc18-0x0026fe90 "
           "(look for a SECOND store to struct-base+8, i.e. target address 0x0040DB60):\n");
    dump_range(ee, 0x0026fc18u, 0x0026fe90u);
    return 0;
}
